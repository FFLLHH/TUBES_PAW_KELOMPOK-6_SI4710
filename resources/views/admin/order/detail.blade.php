...
@section('content')
  ...
  <div class="card">
    <div class="card-body">
      <a href="{{ route('shippings.create', ['order_code' => $order->order_code]) }}" class="btn btn-primary">
        Tambah Pengiriman
      </a>
      <a href="javascript:void(0);" onclick="alertconfirm('{{ route('orderDelete', $order->order_code) }}');" class="btn btn-danger float-end">
        Delete Order
      </a>
    </div>
  </div>
