        ...
        <form action="{{ route('categorySave') }}" method="post" enctype="multipart/form-data">
          ...
          <div id="file-upload-form" class="uploader @error('path') is-invalid @enderror">
            ...
            <label for="file-upload" id="file-drag">
              ...
              <div>Unggah gambar kategori</div>
              @error('path')
                <span class="text-danger">{{ $message }}</span><br>
              @enderror
              <div id="notimage" class="hidden">Silakan pilih gambar</div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control  @error('name') is-invalid @enderror" placeholder="Contoh: Ayam" value="{{old('name')}}" required autofocus>
            @error('name') 
