...
<div>
    ...
    <p>Kategori : <a href="{{ route('clientCategoryProducts', $dataProductContent->category->name) }}">{!! str_replace('-', ' ', ucwords($dataProductContent->category->name)) !!}</a></p>
    <p><b>Deskripsi</b></p>
    <div class="form-group">
        <textarea class="form-control autosize" readonly>{{$dataProductContent->desc}}</textarea>
    </div>
    <p><b>Stok : {{$dataProductContent->stock}}</b></p>
    ...
    <button class="btn btn-primary btn-small font-secondary mt-4 add-to-cart" data-id-product="{{$dataProductContent->id}}" data-quantity="1">Tambah ke keranjang</button>
    @endif
</div>
@push('js')
    <script>
      ...
      $(".add-to-cart").click(function (e) {
        ...
        $.ajax({
          ...
          statusCode: {
            ...
            201: () => {
              Toastify({
                text: "Berhasil Memperbarui Jumlah di Keranjang",
                duration: 3000,
                close:true,
                gravity:"top",
                position: "right",
            ...
            202: () => {
              Toastify({
                text: "Jumlah Produk Sudah Maksimal di Keranjang",
                duration: 3000,
                close:true,
                gravity:"top",
                position: "right",
